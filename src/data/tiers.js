...
export const TIERS = [
  {
    ...
    inside: [
      ...
      'Basic qualification, so you know who’s serious before you follow up',
      'Covers one service line or business area',
      'Hands anything that needs a human straight to you, and never oversteps',
    ],
  ...
  },
  {
    ...
    intro: 'The complete customer engine, with a home of its own. A done-for-you lead-capture website and the system behind it: it answers, follows up, nurtures, and books. This is where most businesses recover the customers they were losing, the ones who reached out once and were never followed up.',
    insideLabel: 'Everything in Catalyst, plus',
    inside: [
      'A done-for-you lead-capture website in your brand, built to turn visitors into booked appointments and feed the engine',
      'Inbound calls answered by AI voice on the first ring, every time, with no call left in voicemail',
