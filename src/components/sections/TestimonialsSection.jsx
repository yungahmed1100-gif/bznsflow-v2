  ...
  return (
    <section className="section" id="testimonials">
      <div className="container">
        <div className="section-label" data-reveal>{t.testimonials_label}</div>
        <h2 className="section-title" data-reveal dangerouslySetInnerHTML={{ __html: t.testimonials_title }} />
        <p className="section-subtitle" data-reveal>{t.testimonials_sub}</p>
        ...
        <div className="testimonials-grid">
          {[
            ...
            { quote: t.tst3_quote, name: t.tst3_name, title: t.tst3_title, location: t.tst3_location, initial: 'SA' },
          ].map((tst, i) => (
            <figure className="testimonial-card" data-reveal key={i}>
